import { imageProyect } from "./images";
import { imageSkill } from "./images";

export const proyects = [
    {
      id: 0,
      name: "Hyper Mega Red",
      image: imageProyect.Proyect1,
